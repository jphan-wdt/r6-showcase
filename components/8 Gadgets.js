...
export default function Gadgets() {
  const tabData = {
    topLeft: `A portable projectile breaching weapon. 
    ...
    topRight: `A specialized laminated glass, which when deployed with oxyacetylene can carve out a one-way mirror on any wall. 
    ...
    bottomLeft: `A localized fission reaction, while keeping gamma radiation to tolerable levels. 
    ...
    bottomRight: `The Shock Drone can scout locations and deliver an electric shock via probes that can incapacitate electrical 
  ...
  return (
    <SlideUp className={section.sectionContainer}>
      <SlideUp className={section.caption}>
        Tech meets tactics. Tools of the trade at your command. Unveil the
        gadgets that turn the tide of the battle.
      </SlideUp>
      ...
      <SlideUp className={gadgets.flexContainer}>
        <SlideUp className={gadgets.flexRow}>
          <SlideUp className={gadgets.flexCard}>
            <div className={gadgets.imageContainer}>
              <Image className={gadgets.picture} src={ash} />
            </div>
          ...
          <SlideUp className={gadgets.flexCard}>
            <div className={gadgets.imageContainer}>
              <Image className={gadgets.picture} src={mira} />
            </div>
        ...
        <SlideUp className={gadgets.flexRow}>
          <SlideUp className={gadgets.flexCard}>
            <div className={gadgets.imageContainer}>
              <Image className={gadgets.picture} src={twitch} />
            </div>
          ...
          <SlideUp className={gadgets.flexCard}>
            <div className={gadgets.imageContainer}>
              <Image className={gadgets.picture} src={thatcher} />
            </div>
